...
steepest_spill_pairs = util.remap_steepest_spill_pairs(new_watersheds, spill_pairs, landscape.ny, landscape.nx)
spill_heights = util.get_spill_heights(new_watersheds, landscape.heights, steepest_spill_pairs)
size_of_traps = util.get_size_of_traps(new_watersheds, landscape.heights, spill_heights)
threshold = 1000

plot.plot_traps(new_watersheds, spill_heights, threshold, landscape, 4)
