...
upslope_indices, node_levels = river_analysis.get_upslope_watersheds(conn_mat, w_nr)
downslope_indices = river_analysis.get_downslope_watersheds(conn_mat, w_nr)
